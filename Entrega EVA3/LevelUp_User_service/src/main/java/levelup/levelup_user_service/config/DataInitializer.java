...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        logger.info("Inicializando datos de usuarios...");
        ...
        logger.info("🚀 User Service iniciado correctamente en puerto 8082");
        logger.info("=".repeat(60));
        ...
        logger.info("   POST   http://localhost:8082/api/usuarios/login");
        logger.info("   POST   http://localhost:8082/api/usuarios/registro");
        logger.info("   GET    http://localhost:8082/api/usuarios/health");
        logger.info("=".repeat(60));
    }
}
